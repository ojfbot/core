...
All commands are available in Claude Code as `/command-name`. The TypeScript engine (`@core/workflows`) runs the same commands programmatically outside Claude Code.
