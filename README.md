...
decisions/
  adr/                Architecture Decision Records (ADR-0001 through ADR-0096+, including ADR-0037 JSONL truncation, ADR-0043 AgentBead bridge, ADR-0085/0070 vault reachability, ADR-0096 skill-architecture taxonomy)
