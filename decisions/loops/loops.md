...
loops:
  ...
  - slug: harness-merge-quiz
    ...
    stop_rule: "SHADOW-FIRST (ADR-0086) — observe-only, emits no permission decision, never blocks a merge; bash prefilter rejects non-merge commands in ~4ms without spawning node"
