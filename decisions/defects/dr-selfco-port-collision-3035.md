...
location: "selfco:wiki/entities/gcgcca.md:5"
claim: "ports: [3035, 3036]"
actual: "3035/3036 are asset-foundry's; gcgcca binds nothing. Two entities declare the same ports."
claim_probe: "grep -q '^ports: \[3035, 3036\]' ~/selfco/wiki/entities/gcgcca.md"
...
`entities/asset-foundry.md:5` and `entities/gcgcca.md:5` both declare `ports: [3035, 3036]`.
`core/CLAUDE.md` assigns 3035 to asset-foundry and no port to gcgcca. A live check found
...
uniqueness lint. Interim: correct gcgcca's value to `[]`.

## Closure

`claim_probe` exits non-zero once gcgcca no longer declares 3035/3036. `truth_probe`
